...
class Omnid_Model:
  ...
  def __init__(self, urdfRootPath='', use_spring=False, test_with_end_effector_xyz=False, after_spring_actuated=False, urdf_name="delta_robot_pybullet.urdf", base_position = [0,0,0]):
    self.urdfRootPath = urdfRootPath
    self.use_spring = use_spring
    self.reset(test_with_end_effector_xyz, after_spring_actuated, urdf_name, base_position)
